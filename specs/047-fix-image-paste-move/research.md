...
- **Use `activePageIdRef`**: Rejected because this ref tracks the last *selected* page, not necessarily the one the user is viewing. A user may scroll to a different page without selecting anything.
